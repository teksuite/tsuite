        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var u, f, p, _, c, d, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                ...
                Z = Y.convertToPixels = function(t, i, r, s, n) {
                    ...
                    if (_ && (r = -r), "%" === s && -1 !== i.indexOf("border")) o = r / 100 * (u ? t.clientWidth : t.clientHeight);
                        ...
                        if (p.cssText = "border:0 solid red;position:" + G(t, "position") + ";line-height:0;", "%" !== s && f.appendChild) p[u ? "borderLeftWidth" : "borderTopWidth"] = r + s;
                        else {
                ...
                K = function(t, e) {
                    ...
                    if (e = e || Q(t, null))
                        if (i = e.length)
                            for (; --i > -1;) s[e[i].replace(C, k)] = e.getPropertyValue(e[i]);
                        else
                            for (i in e) s[i] = e[i];
                    else if (e = t.currentStyle || t.style)
                        for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(C, k)] = e[i]);
            ...
            var fe = function(t, e, i, r) {
                ...
                de = a.parseComplex = function(t, e, i, r, s, n, a, o, l, h) {
                    ...
                    var f, p, _, c, d, v, y, x, T, w, b, S, C = i.split(", ").join(",").split(" "),
            ...
            var xe, Te = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                ...
                Me = Y.getTransform = function(t, e, i, r) {
                    ...
                    var n, o, l, h, u, f, p, _, c, d, m = i ? t._gsTransform || new Ce : new Ce,
                        g = 0 > m.scaleX,
                        v = 2e-5,
                        y = 1e5,
                ...
                Ne = Y.set3DTransformRatio = function(t) {
                    var e, i, r, s, n, a, o, l, h, u, f, p, c, d, m, g, v, y, x, T, w, b, P, S, C, R = this.data,
                        k = this.t.style,
                        O = R.rotation * L,
                        A = R.scaleX,
                        D = R.scaleY,
                    ...
                    if (O || R.skewX) y = Math.cos(O), x = Math.sin(O), e = y, n = x, R.skewX && (O -= R.skewX * L, y = Math.cos(O), x = Math.sin(O), "simple" === R.skewType && (T = Math.tan(R.skewX * L), T = Math.sqrt(1 + T * T), y *= T, x *= T)), i = -x, a = y;
                    else {
            ...
            h = Ce.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = 0, h.scaleX = h.scaleY = h.scaleZ = 1, ve("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                parser: function(t, e, i, r, n, o, l) {
                    ...
                    var h, u, f, p, _, c, d, m = r._transform = Me(t, s, !0, l.parseTransform),
                        g = t.style,
                        v = 1e-6,
                        y = Te.length,
                        x = l,
                        T = {};
                    if ("string" == typeof x.transform && we) f = F.style, f[we] = x.transform, f.display = "block", f.position = "absolute", X.body.appendChild(F), h = Me(F, null, !1), X.body.removeChild(F);
            ...
            var Ee = function(t) {
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) n.cssText = "", s = !0;
                        ...
                        for (e = this.e.split(" ").join("").split(","), r = e.length; --r > -1;) i = e[r], l[i] && (l[i].parse === a ? s = !0 : i = "transformOrigin" === i ? Pe : l[i].p), Ie(n, i);
    ...
    var e = t.GreenSockGlobals || t,
        ...
        y = function(t, e, i, s, o) {
            ...
            var l, _, p, f, d, y, T, w, x, b, P, S, C, k, R = r(t),
                ...
                U = h(t, "borderLeftWidth", E) + h(t, "borderRightWidth", E),
